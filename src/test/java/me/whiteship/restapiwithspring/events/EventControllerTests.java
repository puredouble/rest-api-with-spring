...
import me.whiteship.restapiwithspring.common.RestDocConfiguration;
...
public class EventControllerTests {
    ...
    public void createEvent() throws Exception {
        ...
        mockMvc.perform(post("/api/events/")
                ...
                .andDo(document("create-event",
                        ...
                        // relaxed prefix 사용하여 응답의 일부만 확인
                        responseFields(
    ...
    @Test
    @TestDescription("입력 값이 잛못된 경우에 에러가 발생하는 테스트")
    public void createEvent_Bad_Request_Wrong_Input() throws Exception {
        EventDto eventDto = EventDto.builder()
                .name("Spring")
                .description("REST API Development with Spring")
                .beginEnrollmentDateTime(LocalDateTime.of(2019, 5, 1, 11, 10, 0))
                .closeEnrollmentDateTime(LocalDateTime.of(2018, 6, 1, 11, 11, 0))
                .beginEventDateTime(LocalDateTime.of(2019, 7, 1, 10, 0, 0))
                .endEventDateTime(LocalDateTime.of(2018, 7, 2, 10, 0, 0))
                .basePrice(10000)
                .maxPrice(200)
                .limitOfEnrollment(100)
                .location("강남역 D2 스타텁 팩토리")
